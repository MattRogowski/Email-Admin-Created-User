...
To Install:
Upload ./inc/plugins/emailacu.php to ./inc/plugins/
Upload ./inc/languages/english/admin/emailacu.lang.php to ./inc/languages/english/admin/
Go to ACP > Plugins > Activate

Information:
When you create a user in the Admin CP, this will email them their username and password, to save having to give them their login details manually.

Gives a URL to login, and to change their password for when they login.
